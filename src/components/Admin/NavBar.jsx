...
const NavBar = () => {
  ...
  return (
    <nav
      dir={langDir}
      className="flex items-center w-full h-16 z-20 absolute top-0 justify-between flex-wrap bg-white py-4 lg:px-12 shadow border-solid "
    >
      ...
      <div className="menu w-full bg-white flex-grow lg:flex lg:items-center lg:w-auto lg:px-3 px-8">
        ...
        <div className="relative mx-auto text-gray-600 lg:block hidden">
          ...
          <button type="submit" className="absolute right-0 top-0 mt-3 mr-2">
            <svg
              ...
              stye={{ enableBackground: "new 0 0 56.966 56.966" }}
              width="512px"
              height="512px"
            >
